...
export const RHProLogo = ({ compact = false, className = '' }: RHProLogoProps) => (
  <div className={`flex items-center gap-3 ${className}`} aria-label="RH Pro">
    <div className="relative grid h-11 w-11 shrink-0 place-items-center rounded-xl border border-cyan-300/40 bg-gradient-to-br from-cyan-500 via-sky-500 to-blue-700 shadow-lg shadow-cyan-950/30">
