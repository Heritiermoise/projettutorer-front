...
export const CreateEntreprisePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-orange-50 to-red-50 dark:from-slate-900 dark:via-amber-900/20 dark:to-red-900/20">
      <PublicNavbar />
      ...
      <section className="pt-32 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-800 dark:text-white mb-6">
            ...
            <br />
            <span className="bg-gradient-to-r from-primary-600 via-orange-600 to-red-600 bg-clip-text text-transparent">en quelques clics</span>
          </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" name="nom" value={formData.nom} onChange={handleChange} className="w-full pl-11 pr-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="Ex: VitaService SARL" required maxLength={50} />
                </div>
              </div>

              <div>
                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Nom commercial</label>
                <input type="text" name="nom_commercial" value={formData.nom_commercial} onChange={handleChange} className="w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="Nom commercial alternative (Ex: Vita)" />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" name="email" value={formData.email} onChange={handleChange} className="w-full pl-11 pr-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="contact@entreprise.com" required />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="tel" name="telephone" value={formData.telephone} onChange={handleChange} className="w-full pl-11 pr-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="+243 ..." required />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" name="adresse" value={formData.adresse} onChange={handleChange} className="w-full pl-11 pr-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="Siège physique de l'entreprise" />
                </div>
              </div>

              <div>
                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Description</label>
                <textarea name="description" value={formData.description} onChange={handleChange} rows={3} className="w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white resize-none transition-all" placeholder="Décrivez brièvement votre secteur d'activité..." />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPassword ? 'text' : 'password'} name="password" value={formData.password} onChange={handleChange} className="w-full pl-11 pr-12 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="Min. 6 caractères" required minLength={6} />
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                    <input type={showConfirmPassword ? 'text' : 'password'} name="password_confirmation" value={formData.password_confirmation} onChange={handleChange} className="w-full pl-11 pr-12 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white dark:bg-slate-700 text-slate-800 dark:text-white transition-all" placeholder="Confirmez le mot de passe" required minLength={6} />
              ...
              <button type="submit" disabled={loading} className="w-full py-4 bg-gradient-to-r from-primary-500 via-orange-500 to-red-500 hover:from-primary-600 hover:via-orange-600 hover:to-red-600 text-white font-bold rounded-xl shadow-xl hover:shadow-2xl transition-all flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed">
                {loading ? (
                  <>
