...
export const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-purple-50 to-primary-50 dark:from-slate-900 dark:via-primary-900/20 dark:to-primary-900/20">
